...
namespace OgamaControls
{
  ...
  /// </summary>
  [ToolboxBitmap(typeof(resfinder), "OgamaControls.CommonControls.PeakMeter.PeakMeter.bmp")]
  public partial class PeakMeterCtrl : Control
  {
    ...
    /// <summary>
    /// Gets or sets the <see cref="PeakMeterStyle"/> of the control.
    /// </summary>
    ...
    /// <summary>
    /// Overridden <see cref="Control.OnHandleDestroyed(EventArgs)"/>
    /// </summary>
    /// <param name="e"></param>
    ...
    /// <summary>
    /// Overridden <see cref="Control.OnBackColorChanged(EventArgs)"/>
    /// </summary>
    /// <param name="e"></param>
    ...
    /// <summary>
    /// Overridden <see cref="Control.OnPaint(PaintEventArgs)"/>
    /// </summary>
    /// <param name="e"></param>
