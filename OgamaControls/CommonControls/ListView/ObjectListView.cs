...
namespace OgamaControls
{
  ...
  public partial class ObjectListView : ListView, ISupportInitialize
  {
    ...
    /// </summary>
    /// <param name="size">A <see cref="Size"/> with the x and y spacing.</param>
    public void SetIconSpacing(Size size)
    {
      NativeMethods.SetIconSpacing(size, this);
    }
    ...
    protected void FillInValues(OLVListItem lvi, object rowObject)
    {
      ...
      lvi.ToolTipText = column.GetToolTipText(rowObject);
    ...
    protected override bool ProcessDialogKey(Keys keyData)
    {
      ...
      if (isSimpleTabKey && this.IsCellEditing)
    ...
    protected Control GetCellEditor(OLVListItem item, int subItemIndex)
    {
      ...
      if (value is int || value is Int16 || value is Int64)
  ...
  internal class NativeMethods
  {
    ...
    /// </summary>
    /// <param name="size">A <see cref="Size"/> with the new spacing for the icons.</param>
    /// <param name="list">The <see cref="ListView"/> to set the spacing for.</param>
    public static void SetIconSpacing(Size size, ListView list)
    {
      int I = (size.Height * 65536) + size.Width;  // the icon spacing
      //Addjust the ListViewtiles
      SendMessage(list.Handle, LVM_SETICONSPACING, 0, I);
    }
  ...
  /// </summary>
  public delegate string ToolTipGetterDelegate(Object rowObject);
  ...
  public partial class OLVColumn : ColumnHeader
  {
    ...
    [Browsable(false),
     DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
    public ToolTipGetterDelegate ToolTipGetter
    {
      get { return tooltipGetter; }
      set { tooltipGetter = value; }
    }
    private ToolTipGetterDelegate tooltipGetter;
    ...
    public string GetToolTipText(object rowObject)
    {
      if (this.imageGetter != null)
        return this.tooltipGetter(rowObject);
      return "";
    }
  ...
  public class FlagRenderer<T> : BaseRenderer //where T : IConvertible
  {
    ...
    public override void Render(Graphics g, Rectangle r)
    {
      ...
      int v2 = ((IConvertible)this.Aspect).ToInt32(NumberFormatInfo.InvariantInfo);
