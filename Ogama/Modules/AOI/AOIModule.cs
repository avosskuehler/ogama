...
namespace Ogama.Modules.AOI
{
  ...
  /// of this form.
  /// </summary>
  /// <remarks>This module is intended to define and display
  ...
  /// rectangular and polylineal shapes for AOI.</remarks>
  public partial class AOIModule : FormWithTrialSelection
  {
    ...
    public void UpdateDatabase()
    {
      ...
      try
      {
        ...
        int affectedrows = Document.ActiveDocument.DocDataSet.AOIsAdapter.Update(Document.ActiveDocument.DocDataSet.AOIs);
    ...
    /// </summary>
    /// <returns><strong>True</strong>, if selection was succesfull, otherwise <strong>false</strong>.</returns>
    protected override bool NewTrialSelected()
    {
      try
      {
        ...
        if (set != null)
        {
          ...
          LoadTrialSlidesIntoTimeline(this.trialTimeLine);

          // Filter the items
          this.bsoAOIs.Filter = "(TrialID='" + trialID + "' AND SlideNr='" + this.trialTimeLine.HighlightedSlideIndex.ToString() + "')";
    ...
    /// </summary>
    /// <remarks>Clipboard text should be tabulator separated and with \n line endings</remarks>
    /// <param name="sender">Source of the event.</param>
    /// <param name="e">An empty <see cref="EventArgs"/></param>
      ...
      if (this.MdiParent.ActiveMdiChild.Name == this.Name)
      {
        try
        {
          ...
          else
          {
            ...
            {
              ((MainForm)this.MdiParent).StatusLabel.Text = "Clipboard content has wrong format, so it could not be inserted into the table.";
            }
          }
    ...
    protected override void InitializeDataBindings()
    {
      ...
      this.colID.DefaultCellStyle = ReadOnlyCellStyle;
      this.colTrialID.DefaultCellStyle = ReadOnlyCellStyle;
      this.colShapeNumPts.DefaultCellStyle = ReadOnlyCellStyle;
      this.colShapePts.DefaultCellStyle = ReadOnlyCellStyle;
      this.colShapeType.DefaultCellStyle = ReadOnlyCellStyle;
    ...
    private void btnExportAOITable_Click(object sender, EventArgs e)
    {
      ...
      if (this.sfdExport.ShowDialog() == DialogResult.OK)
      {
        ...
        using (StreamWriter exportFile = new StreamWriter(filenameExport))
        {
          // Write Documentation
          exportFile.WriteLine("# File: " + Path.GetFileName(filenameExport));
          exportFile.WriteLine("# Created: " + DateTime.Today.Date.ToLongDateString() + "," + DateTime.Now.ToLongTimeString());
          exportFile.WriteLine("# with: " + Application.ProductName + " Version: " + Document.ActiveDocument.ExperimentSettings.OgamaVersion.ToString(3));
          ...
          Ogama.DataSet.OgamaDataSet.AOIsDataTable aois = Document.ActiveDocument.DocDataSet.AOIs;
          ...
          foreach (Ogama.DataSet.OgamaDataSet.AOIsRow aoiRow in aois.Rows)
          {
    ...
    /// <param name="sender">Source of the event.</param>
    /// <param name="e">An empty <see cref="EventArgs"/></param>
    private void btnBubblePen_Click(object sender, EventArgs e)
    {
      Pen backupPen = this.aoiPicture.BubblePen;

      PenStyleDlg dlgBubbleStyle = new PenStyleDlg();
      dlgBubbleStyle.Text = "Define bubble pen style...";
      dlgBubbleStyle.Pen = this.aoiPicture.BubblePen;
      dlgBubbleStyle.PenChanged += new EventHandler<PenChangedEventArgs>(this.dlgBubbleStyle_PenChanged);
    ...
    /// <param name="sender">Source of the event.</param>
    /// <param name="e">An empty <see cref="EventArgs"/></param>
    private void btnBubbleFont_Click(object sender, EventArgs e)
    {
      ...
      FontStyleDlg dlgBubbleFontStyle = new FontStyleDlg();
      ...
      dlgBubbleFontStyle.FontStyleChanged += new EventHandler<FontChangedEventArgs>(this.dlgBubbleStyle_FontStyleChanged);
    ...
    /// <param name="sender">Source of the event.</param>
    /// <param name="e">An empty <see cref="EventArgs"/></param>
    private void btnBubbleBrush_Click(object sender, EventArgs e)
    {
      Brush backupBrush = this.aoiPicture.BubbleBrush;

      BrushStyleDlg dlgBubbleBrush = new BrushStyleDlg();
      dlgBubbleBrush.Text = "Set bubble brush style...";
      dlgBubbleBrush.Brush = this.aoiPicture.BubbleBrush;
      dlgBubbleBrush.BrushStyleChanged += new EventHandler<BrushChangedEventArgs>(this.dlgBubbleStyle_BrushStyleChanged);
    ...
    /// <param name="sender">Source of the event.</param>
    /// <param name="e">An empty <see cref="EventArgs"/></param>
    private void btnArrowPen_Click(object sender, EventArgs e)
    {
      Pen backupPen = this.aoiPicture.ArrowPen;

      PenStyleDlg dlgArrowStyle = new PenStyleDlg();
      dlgArrowStyle.Text = "Define arrow pen style...";
      dlgArrowStyle.Pen = this.aoiPicture.ArrowPen;
      dlgArrowStyle.PenChanged += new EventHandler<PenChangedEventArgs>(this.dlgArrowStyle_PenChanged);
    ...
    /// <param name="sender">Source of the event.</param>
    /// <param name="e">An empty <see cref="EventArgs"/></param>
    private void btnArrowFont_Click(object sender, EventArgs e)
    {
      ...
      FontStyleDlg dlgArrowFontStyle = new FontStyleDlg();
      ...
      dlgArrowFontStyle.FontStyleChanged += new EventHandler<FontChangedEventArgs>(this.dlgArrowStyle_FontStyleChanged);
    ...
    /// <param name="sender">Source of the event.</param>
    /// <param name="e">An empty <see cref="EventArgs"/></param>
    private void btnArrowBrush_Click(object sender, EventArgs e)
    {
      Brush backupBrush = this.aoiPicture.BubbleBrush;

      BrushStyleDlg dlgArrowBrush = new BrushStyleDlg();
      dlgArrowBrush.Text = "Set arrow brush style...";
      dlgArrowBrush.Brush = this.aoiPicture.ArrowBrush;
      dlgArrowBrush.BrushStyleChanged += new EventHandler<BrushChangedEventArgs>(this.dlgArrowStyle_BrushStyleChanged);
    ...
    private void btnStyleNormal_Click(object sender, EventArgs e)
    {
      ...
      SolidBrush backupBrush = new SolidBrush(this.aoiPicture.DefaultFontColor);
      VGAlignment backupAlignment = this.aoiPicture.DefaultTextAlignment;

      PenAndFontStyleDlg dlgDefaultStyle = new PenAndFontStyleDlg();
      ...
      dlgDefaultStyle.PenChanged += new EventHandler<PenChangedEventArgs>(this.dlgDefaultStyle_PenChanged);
      dlgDefaultStyle.FontStyleChanged += new EventHandler<FontChangedEventArgs>(this.dlgDefaultStyle_FontStyleChanged);
      if (dlgDefaultStyle.ShowDialog() == DialogResult.Cancel)
      {
        PenChangedEventArgs ea = new PenChangedEventArgs(backupPen, VGStyleGroup.AOI_NORMAL);
        FontChangedEventArgs eaf = new FontChangedEventArgs(backupFont, backupBrush.Color, backupAlignment, VGStyleGroup.AOI_NORMAL);
    ...
    private void btnStyleTarget_Click(object sender, EventArgs e)
    {
      ...
      SolidBrush backupBrush = new SolidBrush(this.aoiPicture.TargetFontColor);
      VGAlignment backupAlignment = this.aoiPicture.TargetTextAlignment;

      PenAndFontStyleDlg dlgTargetStyle = new PenAndFontStyleDlg();
      ...
      dlgTargetStyle.PenChanged += new EventHandler<PenChangedEventArgs>(this.dlgTargetStyle_PenChanged);
      dlgTargetStyle.FontStyleChanged += new EventHandler<FontChangedEventArgs>(this.dlgTargetStyle_FontStyleChanged);
      if (dlgTargetStyle.ShowDialog() == DialogResult.Cancel)
      {
        PenChangedEventArgs ea = new PenChangedEventArgs(backupPen, VGStyleGroup.AOI_TARGET);
        FontChangedEventArgs eaf = new FontChangedEventArgs(backupFont, backupBrush.Color, backupAlignment, VGStyleGroup.AOI_TARGET);
        this.aoiPicture.PenChanged(this, ea);
        this.aoiPicture.FontStyleChanged(this, eaf);
      }
    }
    ...
    private void btnStyleSearchRect_Click(object sender, EventArgs e)
    {
      ...
      SolidBrush backupBrush = new SolidBrush(this.aoiPicture.SearchRectFontColor);
      VGAlignment backupAlignment = this.aoiPicture.SearchRectTextAlignment;

      PenAndFontStyleDlg dlgSearchRectStyle = new PenAndFontStyleDlg();
      ...
      dlgSearchRectStyle.PenChanged += new EventHandler<PenChangedEventArgs>(this.dlgSearchRectStyle_PenChanged);
      dlgSearchRectStyle.FontStyleChanged += new EventHandler<FontChangedEventArgs>(this.dlgSearchRectStyle_FontStyleChanged);
      if (dlgSearchRectStyle.ShowDialog() == DialogResult.Cancel)
      {
        PenChangedEventArgs ea = new PenChangedEventArgs(backupPen, VGStyleGroup.AOI_SEARCHRECT);
        FontChangedEventArgs eaf = new FontChangedEventArgs(backupFont, backupBrush.Color, backupAlignment, VGStyleGroup.AOI_SEARCHRECT);
        this.aoiPicture.PenChanged(this, ea);
        this.aoiPicture.FontStyleChanged(this, eaf);
      }
    }
    ...
    private void btnNewRectangle_Click(object sender, EventArgs e)
    {
      ...
      this.btnNewPolyline.Checked = false;
      this.btnNewAOIGrid.Checked = false;
      this.aoiPicture.NewRectangleStart(ShapeDrawAction.NameAndEdge, null, null, null, Color.Empty, VGStyleGroup.AOI_NORMAL, string.Empty);
    }
    ...
    private void btnNewEllipse_Click(object sender, EventArgs e)
    {
      ...
      this.btnNewPolyline.Checked = false;
      this.btnNewAOIGrid.Checked = false;
      this.aoiPicture.NewEllipseStart(ShapeDrawAction.NameAndEdge, null, null, null, Color.Empty, VGStyleGroup.AOI_NORMAL, string.Empty);
    }
    ...
    private void btnNewPolyline_Click(object sender, EventArgs e)
    {
      ...
      this.btnNewAOIGrid.Checked = false;
      this.aoiPicture.NewPolylineStart(ShapeDrawAction.NameAndEdge, null, null, null, Color.Empty, VGStyleGroup.AOI_NORMAL, string.Empty);
    }
    ...
    /// <param name="sender">Source of the event</param>
    /// <param name="e">An empty <see cref="EventArgs"/></param>
    private void btnAddShapeGroup_Click(object sender, EventArgs e)
    {
    ...
    private void btnSeekNextSlide_Click(object sender, EventArgs e)
    {
      ...
      this.bsoAOIs.Filter = "(TrialID='" + this.CurrentTrial.ID + "' AND SlideNr='" + slideIndex.ToString() + "')";
      this.UpdatePicture();
    }
    ...
    /// </summary>
    /// <param name="sender">Source of the event.</param>
    /// <param name="e">The <see cref="DataGridViewRowEventArgs"/> with the event data.</param>
    ...
    /// </summary>
    /// <param name="sender">Source of the event.</param>
    /// <param name="e">A <see cref="DataGridViewDataErrorEventArgs"/> with the exception to handle.</param>
    ...
    /// </summary>
    /// <param name="sender">Source of the event.</param>
    /// <param name="e">The <see cref="DataGridViewCellEventArgs"/> with the event data.</param>
    ...
    private void aoiPicture_ShapeDeleted(object sender, ShapeEventArgs e)
    {
      try
      {
    ...
    private void aoiPicture_ShapeChanged(object sender, ShapeEventArgs e)
    {
      ...
      try
      {
        ...
        string expression = "ShapeName = '" + shapeName + "' AND TrialID = '" +
          trialID.ToString() + "'";
        DataRow[] foundRows;
    ...
    /// </summary>
    /// <param name="sender">Source of the event</param>
    /// <param name="e">A <see cref="BrushChangedEventArgs"/> with brush to change.</param>
    ...
    private void cmnuSelectElement_Click(object sender, EventArgs e)
    {
      ...
      {
        string nameOfShapeToSelect = this.dgvAOIs.Rows[this.dgvAOIs.CurrentRow.Index].Cells["colShapeName"].Value.ToString();
    ...
    {
      GroupNameDlg dlg = new GroupNameDlg();
      if (dlg.ShowDialog() == DialogResult.OK)
      {
        Ogama.DataSet.OgamaDataSet.ShapeGroupsRow workRowShapeGroups =
    ...
    {
      VisualizationModes visualizationMode = VisualizationModes.None;
    ...
    /// drawing function
    /// </summary>
    /// <param name="newPen">The <see cref="Pen"/> to use for the edge.</param>
    /// <param name="newBrush">The <see cref="Brush"/> to use for the fill.</param>
    /// <param name="newFont">The <see cref="Font"/> to use.</param>
    /// <param name="newFontColor">The <see cref="Color"/> to use for the font.</param>
    /// <param name="newTextAlignment">The <see cref="VGAlignment"/> to use.</param>
    /// <param name="styleGroup">The <see cref="VGStyleGroup"/> this style should belong to.</param>
    ...
    {
      ShapeDrawAction drawAction = ShapeDrawAction.None;
      ...
      ShapePropertiesChangedEventArgs ea = new ShapePropertiesChangedEventArgs(
        drawAction,
        newPen,
        newBrush,
        newFont,
    ...
    /// </summary>
    /// <param name="cells">A <see cref="string"/> array with AOI columns.</param>
