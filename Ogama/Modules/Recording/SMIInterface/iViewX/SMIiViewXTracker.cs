...
namespace Ogama.Modules.Recording.SMIInterface.iViewX
{
  ...
  /// </summary>
  public class SMIiViewXTracker : SMITracker
  {
    ///////////////////////////////////////////////////////////////////////////////
    // Defining Constants                                                        //
    ///////////////////////////////////////////////////////////////////////////////
    ...
    public SMIiViewXTracker(
      ...
      Properties.Settings.Default.EyeTrackerSettingsPath + "SMIiViewXSetting.xml",
      new SMIiViewXClient())
    {
    ...
    /// <summary>
    /// Checks if the iViewX tracker is available in the system.
    /// </summary>
    /// <param name="errorMessage">Out. A <see cref="String"/> with an error message.</param>
    /// <returns><strong>True</strong>, if iViewX tracker
    ...
    {
      errorMessage = "The status of the SMI iViewX tracking device cannot be automatically determined.";
