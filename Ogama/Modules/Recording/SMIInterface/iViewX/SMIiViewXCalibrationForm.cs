...
namespace Ogama.Modules.Recording.SMIInterface.iViewX
{
  ...
  /// </summary>
  public partial class SMIiViewXCalibrationForm : Form
  {
    ///////////////////////////////////////////////////////////////////////////////
    // Defining Constants                                                        //
    ///////////////////////////////////////////////////////////////////////////////
    ...
    /// </summary>
    public SMIiViewXCalibrationForm()
    {
    ...
    public void ShowCalibrationPoint(int calibrationPointIndex)
    {
      if (this.calibrationPoints.Count >= calibrationPointIndex)
      {
        ...
        this.Invalidate();
        Console.WriteLine("ShowCalibrationPoint, currentPointLocation:" + this.currentPointLocation);
      }
    }
