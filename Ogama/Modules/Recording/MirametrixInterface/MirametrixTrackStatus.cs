// <copyright file="MirametrixTrackStatus.cs" company="FU Berlin">
// ******************************************************
...
namespace Ogama.Modules.Recording.MirametrixInterface
{
  ...
  /// </summary>
  public partial class MirametrixTrackStatus : Form
  {
    ///////////////////////////////////////////////////////////////////////////////
    // Defining Constants                                                        //
    ///////////////////////////////////////////////////////////////////////////////
    ...
    /// <summary>
    /// Initializes a new instance of the MirametrixTrackStatus class.
    /// </summary>
    public MirametrixTrackStatus()
    {
      this.InitializeComponent();
      this.memDrawArea = new Bitmap(this.pbTrackStatusMirametrix.Width, this.pbTrackStatusMirametrix.Height);
      this.pbTrackStatusMirametrix.Image = this.memDrawArea;
    ...
    {
      ////this.mirametrixTrackStatusControl.UpdateStatus(gazePosX, gazePosY, posAccuracy);
      this.memLeftEyePosX = (gazePosX * this.pbTrackStatusMirametrix.Width) - this.memDistanceBetweenEyes;
      this.memLeftEyePosY = gazePosY * this.pbTrackStatusMirametrix.Height;
      this.memRightEyePosX = (gazePosX * this.pbTrackStatusMirametrix.Width) + this.memDistanceBetweenEyes;
      this.memRightEyePosY = gazePosY * this.pbTrackStatusMirametrix.Height;
    ...
    private void MirametrixTrackStatus_Load(object sender, System.EventArgs e)
    {
      Graphics drawer;
    ...
    /// <param name="sender">Source of the event.</param>
    /// <param name="e">An empty</param>
    private void pbTrackStatusMirametrix_Paint(object sender, PaintEventArgs e)
    {
      Graphics drawer;
      drawer = Graphics.FromImage(this.memDrawArea);
