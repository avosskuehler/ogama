...
namespace Ogama.Modules.Recording.EyeTechInterface
{
  ...
  public class EyeTechSetting
  {
    ...
    /// <summary>
    /// Gets or sets the calibration options.
    /// </summary>
    public CalibrationOptions CalibrationOptions
    {
      get
      {
        return this.calibrationOptions;
      }

      set
      {
        this.calibrationOptions = value;
      }
    }
    ...
    /// <summary>
    /// Gets or sets the clicking options.
    /// </summary>
    public ClickingOptions ClickingOptions
    {
      get
      {
        return this.clickingOptions;
      }

      set
      {
        this.clickingOptions = value;
      }
    }
