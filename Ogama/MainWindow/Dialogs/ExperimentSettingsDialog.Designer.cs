namespace Ogama.MainWindow.Dialogs
{
  ...
  partial class ExperimentSettingsDialog
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.btnOK.Location = new System.Drawing.Point(315, 552);
      ...
      this.btnCancel.Location = new System.Drawing.Point(385, 552);
      ...
      this.toolTip1.SetToolTip(this.txbSamplingRateMouse, "The samling frequency in \r\nsamples per second for the internal mouse tracker.\r\nCa" +
        "n be independent of the gaze tracking frequency.\r\nShould be around 10 Hz for not" +
        " using cpu too much.");
      ...
      this.toolTip1.SetToolTip(this.txbSamplingRateGaze, "The samling frequency in samples per second \r\nfor the gaze tracking device\r\n(e.g." +
        " 60 or 120 or 500 samples per second)");
      ...
      this.toolTip1.SetToolTip(this.nudMinGazeSamples, resources.GetString("nudMinGazeSamples.ToolTip"));
      ...
      this.toolTip1.SetToolTip(this.nudMaxDistanceGaze, "If the following gaze sample is more than this amount of pixels\r\naway from the ce" +
        "nter of the foregoing fixation, then this is will\r\nconsidered to be the beginnig" +
        " of a saccade.");
    ...
    "and still be considered part of the fixation.";
      ...
      this.chbEliminateFirstFixationSimple.Location = new System.Drawing.Point(9, 234);
      this.chbEliminateFirstFixationSimple.Name = "chbEliminateFirstFixationSimple";
      this.chbEliminateFirstFixationSimple.Size = new System.Drawing.Size(311, 17);
      this.chbEliminateFirstFixationSimple.TabIndex = 24;
      this.chbEliminateFirstFixationSimple.Text = "Simply eliminate first fixation without any additional conditions";
      this.toolTip1.SetToolTip(this.chbEliminateFirstFixationSimple, "With this option checked, the very first fixation of each trial,\r\nno matter what " +
        "other paramters say will be erased from the\r\ndatabase and not used in any analys" +
        "is.");
    ...
    "rial and shorter than";
      ...
      this.toolTip1.SetToolTip(this.nudFixationRingSize, resources.GetString("nudFixationRingSize.ToolTip"));
      ...
      this.toolTip1.SetToolTip(this.nudMaxDistanceMouse, "If the following mouse sample is more than this amount of pixels\r\naway from the c" +
        "enter of the foregoing fixation, then this is will\r\nconsidered to be the beginni" +
        "g of a mouse movement.");
      ...
      this.toolTip1.SetToolTip(this.nudMinMouseSamples, "This is the amount of samples that should be at minimum in \r\nthe range of the dis" +
        "tance above, to be sure that there was a fixation.\r\nThis value heavily depends o" +
        "n the sampling rate.");
    ...
    "ill give the fixations circle diameter.";
      ...
      this.grbFixParams.Location = new System.Drawing.Point(54, 479);
    ...
    private System.Windows.Forms.CheckBox chbEliminateFirstFixationSimple;
  }
}