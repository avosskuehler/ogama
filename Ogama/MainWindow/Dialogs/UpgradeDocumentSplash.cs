// <copyright file="UpgradeDocumentSplash.cs" company="FU Berlin">
// ******************************************************
...
namespace Ogama.MainWindow.Dialogs
{
  ...
  public partial class UpgradeDocumentSplash : Form
  {
    ...
    /// <summary>
    /// Initializes a new instance of the UpgradeDocumentSplash class.
    /// </summary>
    public UpgradeDocumentSplash()
    {
    ...
    private void UpgradeDocumentSplash_Load(object sender, EventArgs e)
    {
      this.timer1.Start();
    }
