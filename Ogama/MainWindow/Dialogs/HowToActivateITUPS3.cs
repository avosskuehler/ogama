// <copyright file="HowToActivateITUPS3.cs" company="FU Berlin">
// ******************************************************
...
namespace Ogama.MainWindow
{
  ...
  /// </summary>
  public partial class HowToActivateITUPS3 : Form
  {
    ///////////////////////////////////////////////////////////////////////////////
    // Defining Constants                                                        //
    ///////////////////////////////////////////////////////////////////////////////
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="HowToActivateITUPS3"/> class.
    /// </summary>
    public HowToActivateITUPS3()
    {
    ...
    /// <summary>
    /// The <see cref="Control.Click"/> event handler for
    /// the <see cref="PictureBox"/> <see cref="pcbEyeWriter"/>.
    /// User clicked the Tempt logo, so open the EyeWriter website.
    /// </summary>
    /// <param name="sender">Source of the event.</param>
    /// <param name="e">An empty <see cref="EventArgs"/></param>
    private void pcbEyeWriter_Click(object sender, EventArgs e)
    {
    ...
    /// <summary>
    /// The <see cref="LinkLabel.LinkClicked"/> event handler for
    /// the <see cref="LinkLabel"/> <see cref="llbEyeWriter"/>.
    /// User clicked to open the EyeWriter Manual.
    /// </summary>
    /// <param name="sender">Source of the event.</param>
    /// <param name="e">A <see cref="LinkLabelLinkClickedEventArgs"/> with the event data.</param>
    private void llbEyeWriter_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
    {
      System.Diagnostics.Process.Start("http://fffff.at/eyewriter/The-EyeWriter.pdf");
    }

    /// <summary>
    /// The <see cref="LinkLabel.LinkClicked"/> event handler for
    /// the <see cref="LinkLabel"/> <see cref="llbCodeLaboratories"/>.
    /// User clicked to open the Code laboratories link.
    /// </summary>
    /// <param name="sender">Source of the event.</param>
    /// <param name="e">A <see cref="LinkLabelLinkClickedEventArgs"/> with the event data.</param>
    private void llbCodeLaboratories_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
    {
