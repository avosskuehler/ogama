...
{
  partial class HowToActivateSMIRedM
  {
    /// <summary>
    ...
    {
      System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(HowToActivateSMIRedM));
      ...
      this.label1.Text = "To enable the recording with Senso Motoric Instruments (SMI) Red-M tracking syste" +
    "m please perform the following steps:";
      // 
      // pcbSMI
      // 
      this.pcbSMI.Image = global::Ogama.Properties.Resources.SMIRedMFoto64;
      ...
      this.Name = "HowToActivateSMIRedM";
      this.ShowInTaskbar = false;
      this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
      this.Text = "HowTo: Activate SMI Red-M recording...";
