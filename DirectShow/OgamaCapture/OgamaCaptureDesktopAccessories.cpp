...
//
HRESULT COgamaCapturePinDesktop::CheckMediaType(const CMediaType *pMediaType)
{
...
HRESULT COgamaCapturePinDesktop::SetMediaType(const CMediaType *pMediaType)
{
    CAutoLock cAutoLock(m_pFilter->pStateLock());
...
HRESULT STDMETHODCALLTYPE COgamaCapturePinDesktop::SetFormat(AM_MEDIA_TYPE *pmt)
{
    CAutoLock cAutoLock(m_pFilter->pStateLock());
...
HRESULT STDMETHODCALLTYPE COgamaCapturePinDesktop::GetFormat(AM_MEDIA_TYPE **ppmt)
{
    CAutoLock cAutoLock(m_pFilter->pStateLock());
...
HRESULT STDMETHODCALLTYPE COgamaCapturePinDesktop::GetNumberOfCapabilities(int *piCount, int *piSize)
{
    *piCount = 7;
...
HRESULT STDMETHODCALLTYPE COgamaCapturePinDesktop::GetStreamCaps(int iIndex, AM_MEDIA_TYPE **pmt, BYTE *pSCC)
{
    CAutoLock cAutoLock(m_pFilter->pStateLock());
...
HRESULT COgamaCapturePinDesktop::QuerySupported(REFGUID guidPropSet, DWORD dwPropID, DWORD *pTypeSupport)
{
...
STDMETHODIMP COgamaCaptureDesktop::Stop(){
...
// according to msdn...
HRESULT COgamaCaptureDesktop::GetState(DWORD dw, FILTER_STATE *pState)
{
...
HRESULT COgamaCapturePinDesktop::QueryInterface(REFIID riid, void **ppv)
{   
...
HRESULT COgamaCapturePinDesktop::Set(REFGUID guidPropSet, DWORD dwID, void *pInstanceData, 
...
HRESULT COgamaCapturePinDesktop::Get(
...
//
HRESULT COgamaCapturePinDesktop::GetMediaType(int iPosition, CMediaType *pmt) // AM_MEDIA_TYPE basically == CMediaType
{
