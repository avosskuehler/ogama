...
// File: Setup.cpp
//
// Desc: DirectShow sample code - implementation of OgamaCapture sample filters
//
...
const AMOVIESETUP_FILTER sudOgamaCaptureDesktop =
{
    &CLSID_OgamaCaptureDesktop,// Filter CLSID
    g_wszOgamaCaptureDesktop,       // String name
...
{
    { 
      g_wszOgamaCaptureDesktop,               // Name
      &CLSID_OgamaCaptureDesktop,       // CLSID
      COgamaCaptureDesktop::CreateInstance, // Method to create an instance of MyComponent
      NULL,                           // Initialization function
      &sudOgamaCaptureDesktop           // Set-up information (for filters)
    },
};
