// <copyright file="PenConverter.cs" company="FU Berlin">
// ******************************************************
...
namespace VectorGraphics.Tools.CustomTypeConverter
{
  ...
  /// to and from the <see cref="Pen"/> object.
  /// </summary>
  public class PenConverter : ExpandableObjectConverter
  {
    /// <summary>
    ...
    /// the object to the specified type <see cref="Pen"/>. 
    /// </summary>
    /// <param name="context">An <see cref="ITypeDescriptorContext"/> that 
    /// provides a format context.</param>
      ...
      object value)
    {
      if (value is string)
      {
        return ObjectStringConverter.StringToPen((string)value);
      }
    ...
    {
      if (destinationType == typeof(string) && value is Pen)
      {
        return ObjectStringConverter.PenToString((Pen)value);
      }
      ...
      Attribute[] attributes)
    {
      ...
      usedProperties.Add(properties["Alignment"]);
      usedProperties.Add(properties["Color"]);
      usedProperties.Add(properties["DashCap"]);
      usedProperties.Add(properties["DashOffset"]);
      usedProperties.Add(properties["DashStyle"]);
      usedProperties.Add(properties["EndCap"]);
      usedProperties.Add(properties["LineJoin"]);
      usedProperties.Add(properties["MiterLimit"]);
      usedProperties.Add(properties["StartCap"]);
      usedProperties.Add(properties["Width"]);

      PropertyDescriptorCollection filteredProperties = new PropertyDescriptorCollection(usedProperties.ToArray());
